...
//   3. The cadence is re-anchored when a session starts, after the player's
//      saved opt-in and locale are restored.
...
export interface ReturnReminders {
    /** Schedule the whole cadence. Safe to call when a session starts. */
